...
const WEEKLY_SETS = [
  {
    ...
    prompts: [
      ...
      { file: 'slot-2.jpg', name: 'AI Action Figure Box', prompt: 'Photorealistic product photography of a plastic toy action figure still sealed in its original retail box packaging. Clear plastic window showing the toy inside. Colorful cardboard backing with brand graphics. The toy is a miniature human-like superhero figure, not a robot. Bright studio lighting, clean white background, commercial product photography quality 8K.' },
  ...
  },
  {
    ...
    prompts: [
      ...
      { file: 'slot-3.jpg', name: 'Volcanic Dragon Lair', prompt: 'Majestic ancient dragon with intricate iridescent scale detail resting in a volcanic mountain cave. Glowing magma rivers casting warm orange light. Vast treasure surrounding the creature. Epic fantasy art meets photorealism. Ultra-detailed 8K cinematic.' },
  ...
  },
  {
    ...
    prompts: [
      ...
      { file: 'slot-4.jpg', name: 'Horror Atmosphere', prompt: 'Mysterious atmospheric Gothic mansion interior at night. Moonlight through tall arched windows casting long shadows. Candelabras flickering. Grand staircase with ornate railings. Dusty paintings on the walls. High contrast desaturated. Dark academia aesthetic. Kubrick visual style masterpiece.' },
    ]
  },
  {
    week: 11,
